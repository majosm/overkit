...
void ovkResetAssemblyOptionOverlapTolerance(ovk_assembly_options *Options, int MGridID, int
  NGridID);
...
void ovkResetAssemblyOptionCutBoundaryHoles(ovk_assembly_options *Options, int MGridID, int
  NGridID);
