...
template <typename T, array_layout Layout> collect_base<T, Layout>::collect_base() = default;
template <typename T, array_layout Layout> collect_base<T, Layout>::collect_base(collect_base
  &&Other) noexcept = default;
template <typename T, array_layout Layout> collect_base<T, Layout> &collect_base<T, Layout>::
  operator=(collect_base &&Other) noexcept = default;

template <typename T, array_layout Layout> void collect_base<T, Layout>::Initialize(const exchange
  &Exchange, int Count, const range &GridValuesRange) {
...
template <typename T, array_layout Layout> void collect_base<T, Layout>::AllocateRemoteDonorValues(
...
template <typename T, array_layout Layout> void collect_base<T, Layout>::RetrieveRemoteDonorValues(
  array_view<array_view<const value_type>> GridValues, array<array<value_type,2>>
  &RemoteDonorValues) {
...
template <typename T, array_layout Layout> void collect_base<T, Layout>::AssembleDonorPointValues(
  array_view<array_view<const value_type>> GridValues, const array<array<value_type,2>>
  &RemoteDonorValues, long long iDonor, elem<int,MAX_DIMS> &DonorSize, array_view<value_type,2>
  DonorPointValues) {
...
template class collect_base<bool, array_layout::ROW_MAJOR>;
template class collect_base<bool, array_layout::COLUMN_MAJOR>;
template class collect_base<unsigned char, array_layout::ROW_MAJOR>;
template class collect_base<unsigned char, array_layout::COLUMN_MAJOR>;
template class collect_base<int, array_layout::ROW_MAJOR>;
template class collect_base<int, array_layout::COLUMN_MAJOR>;
template class collect_base<long, array_layout::ROW_MAJOR>;
template class collect_base<long, array_layout::COLUMN_MAJOR>;
template class collect_base<long long, array_layout::ROW_MAJOR>;
template class collect_base<long long, array_layout::COLUMN_MAJOR>;
template class collect_base<unsigned int, array_layout::ROW_MAJOR>;
template class collect_base<unsigned int, array_layout::COLUMN_MAJOR>;
template class collect_base<unsigned long, array_layout::ROW_MAJOR>;
template class collect_base<unsigned long, array_layout::COLUMN_MAJOR>;
template class collect_base<unsigned long long, array_layout::ROW_MAJOR>;
template class collect_base<unsigned long long, array_layout::COLUMN_MAJOR>;
template class collect_base<float, array_layout::ROW_MAJOR>;
template class collect_base<float, array_layout::COLUMN_MAJOR>;
template class collect_base<double, array_layout::ROW_MAJOR>;
template class collect_base<double, array_layout::COLUMN_MAJOR>;
