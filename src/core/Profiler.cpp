...
const map_noncontig<int,std::string> profiler::TimerNames_ = {
  ...
  {ASSEMBLER_OVERLAP_SUBDIVIDE_TIME, "Assembler::Overlap::Subdivide"},
  {ASSEMBLER_OVERLAP_BB_TIME, "Assembler::Overlap::BoundingBox"},
  {ASSEMBLER_OVERLAP_BB_CREATE_HASH_TIME, "Assembler::Overlap::BoundingBox::CreateHash"},
  {ASSEMBLER_OVERLAP_BB_MAP_TO_BINS_TIME, "Assembler::Overlap::BoundingBox::MapToBins"},
  {ASSEMBLER_OVERLAP_BB_RETRIEVE_BINS_TIME, "Assembler::Overlap::BoundingBox::RetrieveBins"},
