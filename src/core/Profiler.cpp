...
const map_noncontig<int,std::string> profiler::TimerNames_ = {
  ...
  {ASSEMBLER_OVERLAP_FRAGMENT_TIME, "Assembler::Overlap::Fragment"},
  {ASSEMBLER_OVERLAP_HASH_TIME, "Assembler::Overlap::Hash"},
  {ASSEMBLER_OVERLAP_HASH_CREATE_TIME, "Assembler::Overlap::Hash::Create"},
  {ASSEMBLER_OVERLAP_HASH_MAP_TO_BINS_TIME, "Assembler::Overlap::Hash::MapToBins"},
  {ASSEMBLER_OVERLAP_HASH_RETRIEVE_BINS_TIME, "Assembler::Overlap::Hash::RetrieveBins"},
  {ASSEMBLER_OVERLAP_CONNECT_TIME, "Assembler::Overlap::Connect"},
  {ASSEMBLER_OVERLAP_SEARCH_TIME, "Assembler::Overlap::Search"},
  {ASSEMBLER_OVERLAP_SEARCH_BUILD_ACCEL_TIME, "Assembler::Overlap::Search::BuildAccel"},
  {ASSEMBLER_OVERLAP_SEARCH_QUERY_ACCEL_TIME, "Assembler::Overlap::Search::QueryAccel"},
  {ASSEMBLER_OVERLAP_SYNC_TIME, "Assembler::Overlap::Sync"},
  {ASSEMBLER_OVERLAP_CREATE_TIME, "Assembler::Overlap::Create"},
  ...
  {ASSEMBLER_CUT_BOUNDARY_HOLES_PROJECT_CREATE_EXCHANGE_TIME, "Assembler::CutBoundaryHoles::Project::CreateExchange"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_PROJECT_EXCHANGE_TIME, "Assembler::CutBoundaryHoles::Project::Exchange"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_PROJECT_GEN_COVER_TIME, "Assembler::CutBoundaryHoles::Project::GenCover"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_PROJECT_GEN_BOUNDARY_TIME, "Assembler::CutBoundaryHoles::Project::GenBoundary"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_DETECT_EXTERIOR_TIME, "Assembler::CutBoundaryHoles::DetectExterior"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_DETECT_EXTERIOR_SEED_TIME, "Assembler::CutBoundaryHoles::DetectExterior::Seed"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_DETECT_EXTERIOR_FLOOD_TIME, "Assembler::CutBoundaryHoles::DetectExterior::Flood"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_UPDATE_AUX_TIME, "Assembler::CutBoundaryHoles::UpdateAux"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_UPDATE_AUX_GRID_TIME, "Assembler::CutBoundaryHoles::UpdateAux::Grid"},
  {ASSEMBLER_CUT_BOUNDARY_HOLES_UPDATE_AUX_OVERLAP_TIME, "Assembler::CutBoundaryHoles::UpdateAux::Overlap"},
  ...
  {ASSEMBLER_CONNECTIVITY_DONOR_EDGE_DISTANCE_TIME, "Assembler::Connectivity::DonorEdgeDistance"},
  {ASSEMBLER_CONNECTIVITY_DONOR_EDGE_DISTANCE_COMPUTE_DISTANCES_TIME, "Assembler::Connectivity::DonorEdgeDistance::ComputeDistances"},
  {ASSEMBLER_CONNECTIVITY_DONOR_EDGE_DISTANCE_CREATE_EXCHANGE_TIME, "Assembler::Connectivity::DonorEdgeDistance::CreateExchange"},
  {ASSEMBLER_CONNECTIVITY_DONOR_EDGE_DISTANCE_EXCHANGE_TIME, "Assembler::Connectivity::DonorEdgeDistance::Exchange"},
  {ASSEMBLER_CONNECTIVITY_CHOOSE_DONORS_TIME, "Assembler::Connectivity::ChooseDonors"},
  {ASSEMBLER_CONNECTIVITY_SYNC_TIME, "Assembler::Connectivity::Sync"},
  {ASSEMBLER_CONNECTIVITY_SYNC_CREATE_EXCHANGE_TIME, "Assembler::Connectivity::Sync::CreateExchange"},
  {ASSEMBLER_CONNECTIVITY_SYNC_EXCHANGE_TIME, "Assembler::Connectivity::Sync::Exchange"},
  {ASSEMBLER_CONNECTIVITY_SYNC_FINALIZE_TIME, "Assembler::Connectivity::Sync::Finalize"},
  {ASSEMBLER_CONNECTIVITY_CREATE_TIME, "Assembler::Connectivity::Create"},
