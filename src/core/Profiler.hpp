...
public:
  ...
  enum : int {
    ...
    ASSEMBLER_OVERLAP_FRAGMENT_TIME,
    ASSEMBLER_OVERLAP_HASH_TIME,
    ASSEMBLER_OVERLAP_HASH_CREATE_TIME,
    ASSEMBLER_OVERLAP_HASH_MAP_TO_BINS_TIME,
    ASSEMBLER_OVERLAP_HASH_RETRIEVE_BINS_TIME,
